            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Validasi Permintaan Barang</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="row row-cols-12">
            <div class="col">
                <div class="card border-primary border-top border-3 border-0">
                    <div class="card-body">
                        <div class="card-body" id="tabelValidasi">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal fade" id="validasi-modal" data-bs-backdrop="static">
    <div class="modal-dialog modal-fullscreen">
        <div class="modal-content bg-success">
            ...
            <div class="modal-body">
                <div class="card">
                    <div class="card-body" id="tabelDetailPermohonan"></div>
                </div>
            </div>
